    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-uppercase ">Liste des Activités </h3> <a type="button" href="{{ url('contrats-create') }}"
...
<td>{{ $task->activite->coordonnéeGPS ??"-" }}</td>
                            ...
                            {{--  <td
                                class="@if ($task->status === 'En cours') text-green @elseif($task->status === 'Terminer') text-red @endif">
                            ...
                            <td>
                               @if ($task->status === 'Terminer' || auth()->user()->id !== $task->user_id)
    <a href="#" class="btn btn-success disabled" aria-disabled="true" style="opacity: 0.25; cursor: not-allowed;">
        <i class="fas fa-edit"></i> Modifier
    </a>
    <button type="button" class="btn btn-danger disabled" disabled style="opacity: 0.25; cursor: not-allowed;">
        <i class="fas fa-trash"></i> Supprimer
    </button>
@else
    <a href="{{ url('/contrats/' . $task->id . '/edit') }}" class="btn btn-success">
        <i class="fas fa-edit"></i> Modifier
    </a>
...
@endif
    ...
    <button type="button" class="btn btn-danger delete-btn disabled" disabled style="opacity: 0.25; cursor: not-allowed;">
        <i class="fas fa-trash"></i> Supprimer
    </button>
@else
...
@endif  --}}
                                ...
                                {{--  @if ($task->status === 'Terminer')<a href="#" class="btn btn-success disabled" aria-disabled="true" style="opacity: 0.25; cursor: not-allowed;">
                                    <i class="fas fa-edit"></i> Modifier
                                </a>
                                <button type="button" class="btn btn-danger delete-btn disabled" data-bs-toggle="modal"
                                        data-bs-target="#deleteModal{{ $task->id }}" disabled style="opacity: 0.25; cursor: not-allowed;">
                                    <i class="fas fa-trash"></i> Supprimer
                                </button>
