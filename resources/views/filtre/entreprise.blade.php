    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-uppercase ">Activités Par entreprise </h3>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-8 text-end d-flex">
                  <input type="text" id="searchInpute" class="form-control me-2" placeholder="Rechercher par Entreprise ..."> 
            ...
            <input type="text" id="searchInput"  class="form-control me-3" placeholder="Rechercher par Activités...">
              <button onclick="imprimerTable()" class="btn btn-primary text-white d-flex">
                <i class="bi bi-printer mt-1 me-2"></i> Imprimer</button>  
        </div>
