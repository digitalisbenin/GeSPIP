    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-uppercase ">Toutes les activites </h3>
            </div>
        </div>
...
$(document).ready(function() {
 ...
 <script>
    function imprimerTable() {
        ...
        fenetreImpression.document.write('<h2 style="text-align:center; color:green;text-transform: uppercase;">TOUTES LES ACTIVITES</h2>');
