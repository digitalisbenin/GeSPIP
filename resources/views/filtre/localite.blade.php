    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-uppercase ">Activités Par localité </h3>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-8 text-end d-flex">
                 <input type="text" id="searchInpute" class="form-control me-2" placeholder="Rechercher par Localité ..."> 
