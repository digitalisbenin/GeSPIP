    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-uppercase ">Activités par nature </h3>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-8 text-end d-flex">
                  <input type="text" id="searchInpute" class="form-control me-2" placeholder="Rechercher par Nature ..."> 
                    ...
                    @foreach ($contrat as $key => $task)
                        <tr class="text-center" style=" white-space: nowrap;"  >
                           ...
                           <td>{{ \Carbon\Carbon::parse($task->created_at)->format('d/m/Y') }}</td>
                            ...
                            <td class="category-etat" >{{ $task->activite->natureActivite->name }}</td>
